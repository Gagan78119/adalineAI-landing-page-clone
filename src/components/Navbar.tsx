...
export default function Navbar() {
  ...
  return (
    <header
      className="sticky top-0 z-50 w-full bg-adaline-cream/80 backdrop-blur-md border-b border-black/5"
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            >
              <button className="flex items-center gap-1.5 text-[13px] font-medium tracking-wide text-adaline-dark hover:text-adaline-dark/70 transition-colors">
                PRODUCTS
                <motion.svg
                  width="12"
                  height="12"
            ...
            <Link
              href="/pricing"
              className="text-[13px] font-medium tracking-wide text-adaline-dark hover:text-adaline-dark/70 transition-colors"
            >
              PRICING
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/demo"
              className="flex items-center gap-2 px-5 py-2.5 text-[13px] font-medium tracking-wide text-adaline-dark border border-adaline-dark/20 rounded-full hover:border-adaline-dark/40 transition-colors bg-white"
            >
              <span className="w-5 h-5 rounded-full border border-adaline-dark/30 flex items-center justify-center bg-white">
            ...
            <Link
              href="/signup"
              className="group relative px-6 py-2.5 text-[13px] font-medium tracking-wide text-white bg-adaline-primary rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-lg"
            >
              {/* Shine effect */}
